...
x = o_Checkpoint2.x;
y = o_Checkpoint2.y;
o_Camera.x = o_Checkpoint2.x;
o_Camera.y = o_Checkpoint2.y;
}
...
//Caranajo Pack 1
if ((room = CaranajoPack1) && (global.checkpoint = 1)){
	audio_play_sound(sou_RomanceInItalyPR, 1, true, 1, 0, 1, 1);
}
if ((room = CaranajoPack1) && (global.checkpoint != 1)){
	movable = 3;
...
//Caranajo Pack 2
if (room = CaranajoPack2){
	if (global.supertrampoline = 1){
		key = 1;
		y = 900;
		vsp = -20;
		global.supertrampoline = 0;
...
//Caranajo Pack 3
if (room = CaranajoPack3){
	audio_play_sound(sou_RivetedTreegazing, 1, true, 1, 0, 1, 1);
	global.martacutscene = 1;
}
